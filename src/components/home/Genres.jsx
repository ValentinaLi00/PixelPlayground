        ...
        <div className={classes.container}>
            ...
            <div className={classes.containerGenres}>
                ...
                <div className={classes.containerCards}>
                    ...
                    <div className={`${classes.card} ${classes.simulator} `}>
                        <img src="src\assets\valentinaLiAssets\home\genres\simulator_figure.png" alt="" className={`${classes.character} ${classes.figure_simulator}`} />
                        <div className={classes.ribbon}>Simulator</div>
                    </div>
                </div>
            </div>
        </div>
