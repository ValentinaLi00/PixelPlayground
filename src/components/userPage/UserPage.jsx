    ...
    <>
      <div className="userPagediv">
        <div className="uploadPic" onClick={handleImageClick}>
          <h1>user's name</h1>
          {image ? <div><img className="clientPic" src={URL.createObjectURL(image)} alt="" />  <p>clicca per scegliere un'altra foto</p></div> : <div> <img className='uploadImg' src="src\assets\paoloLupoAssets\uploadImage.png" alt="avatar_img" /> </div>}
        ...
        <div className="wholeUserPage">
          <div className="leftUserPart">
            <div className="account">
              <p style={{ fontSize: '23px', fontWeight: '100', color: 'white', textShadow: '0px 0px 15px rgb(205, 0, 185)' }}>ACCOUNT</p>
            ...
            <div className="orders">
              <span style={{ fontSize: '23px', fontWeight: '100', color: 'white', textShadow: '0px 0px 15px rgb(205, 0, 185)' }}>I MIEI ORDINI</span>
          ...
          <div className="rightUserPart">
            <div className="newsletter">
              <span style={{ fontSize: '23px', fontWeight: '100', color: 'white', textShadow: '0px 0px 15px rgb(205, 0, 185)' }}>NEWSLETTER</span>
            ...
            <div className='wishlistAndExit'>
              <div>
                <p style={{ fontSize: '23px', fontWeight: '100', color: 'white', textShadow: '0px 0px 15px rgb(205, 0, 185)' }}>WISHLIST</p>
                <div className="wishlistDivImg"><img className="wishlist" src="\src\assets\paoloLupoAssets\cuore_grande_pixel-removebg-preview.png" alt="heart_wishlist_icon" /></div>
              </div>
              <div>
                <p style={{ fontSize: '23px', fontWeight: '100', color: 'white', textShadow: '0px 0px 15px rgb(205, 0, 185)' }}>EXIT</p>
               <div className="exitDivImg" > <img className="exit" src="src\assets\paoloLupoAssets\exitDoor_icon-removebg-preview.png" alt="exit_icon" /></div>
              </div>
            </div>
          </div>
        </div>
