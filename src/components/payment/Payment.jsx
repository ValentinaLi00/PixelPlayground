            ...
            <div className="payment_box">
                <div className="payment_container">
                    ...
                    {show ? (<div className="input_details">
                        <label htmlFor="input_card_name">Titolare Carta</label>
                        <input className="card_name" type="text" name="input_card_name" id="input_card_name" />

                        <label htmlFor="input_card_number">Numero carta</label>
                        <input className="card_number" type="text" name="input_card_number" id="input_card_number" />

                        <label htmlFor="input_card_expairy">Scadenza</label>
                        <input className="card_expairy" type="text" name="input_card_expairy" id="input_card_expairy" placeholder="MM/AAAA" />

                        <label htmlFor="input_cvv">CVV</label>
                        <input className="card_cvv" type="text" name="input_cvv" id="input_cvv" placeholder="123" />

                        <div className="checkbox_container">
                            <input className="checkbox" type="checkbox" name="checkbox" checked="" />
